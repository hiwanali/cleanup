-- CleanUp · Passerade pass utan incheckning godkänns automatiskt (Utfört, planerad tid)
...
-- Historiska pass som väntade på granskning → räknas som utförda med planerad tid
UPDATE public.shifts
SET
  status = 'Utfört',
  updated_at = now()
WHERE status = 'Väntar granskning';
