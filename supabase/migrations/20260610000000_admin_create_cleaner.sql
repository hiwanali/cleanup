-- CleanUp · Admin provisionerar städare med valt lösenord (§4)
--
-- admin_create_cleaner: skapar auth.users (bekräftad e-post) +
-- public.users (role = cleaner) + ev. property_cleaners i en transaktion.
