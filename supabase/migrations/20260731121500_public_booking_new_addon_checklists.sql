-- CleanUp - public booking addon checklist labels
--
-- Updates the helper used when a public booking is approved/created so the
-- new home-cleaning addons and counted window addon become shift checklist
-- items. Pricing stays in the frontend for now.
