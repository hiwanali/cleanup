-- CleanUp · Väntar granskning (pass utan incheckning) + uppdaterad finalisering + pg_cron 2h

ALTER TABLE public.shifts DROP CONSTRAINT IF EXISTS shifts_status_check;

ALTER TABLE public.shifts ADD CONSTRAINT shifts_status_check CHECK (
  status IN (
    'Planerat',
    'Godkänt',
    'Pågående',
