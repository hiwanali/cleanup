-- CleanUp - smart public booking windows
--
-- Admin availability rows are work windows, for example 08:00-17:00.
-- The public iframe can now request an exact customer cleaning time inside
-- that window, for example 09:00-12:00. The database validates that the
-- requested time fits the window and does not overlap active requests beyond
-- the window capacity.
